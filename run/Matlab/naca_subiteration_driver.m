...
function naca_subiteration_driver(dt, tol, nsubiter, subtol_factor, global_pre, inner_pre, msh_name)

  if nargin < 7; msh_name = "naca_v2_p3_r12"; end;
  if nargin < 6
    inner_pre = "jacobi";
  else
  ...
  fprintf("Running naca_subiteration_driver(dt=%.1e) on mesh %s, nsubiter=%d.\n", dt, msh_name, nsubiter);
  ...
  subiteration_test(J, Ms, JD, Dij, b, bl_elems, dt, tol, nsubiter, subtol_factor, global_pre, inner_pre);
